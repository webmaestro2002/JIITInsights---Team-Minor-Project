...
//                 <Link to={(user || isAdmin) ? '/account' : '/login'} className='flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300'>
        ...
        <div>
            <header className='flex justify-between'>
                ...
                <div className='flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300 bg-black'>
                    ...
                    <Link to="/admin/add" className="flex items-center text-white">
                        Add Admin
                    </Link>
                )}
                </div>
